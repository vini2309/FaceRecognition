...
from mtcnn.mtcnn import MTCNN  # Face Detector it will thorow the bounding boxes of the face
...
class TrainingDataCollector:
    ...
    def collectImagesFromCamera(self):
        ...
        while faces < max_faces:
            ret, frame = cap.read()  # ret is a check variable from open cv2, it will chekc whether face is came from camera or not
            frames += 1
